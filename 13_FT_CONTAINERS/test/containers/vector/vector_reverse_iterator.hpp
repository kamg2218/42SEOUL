...
class	VectorReverseIterator {
	...
	public:
		...
		VectorReverseIterator(const VectorReverseIterator &it) { *this = it; }
		VectorReverseIterator(const VectorConstReverseIterator<T> &it) { *this = it; }
		...
		VectorReverseIterator&	operator=(const VectorConstReverseIterator<T> &it){
...
template<class T>
bool	operator==(const VectorReverseIterator<T> &a, const VectorReverseIterator<T> &b){
	return a.getValue() == b.getValue();
}

template<class T>
bool	operator==(const VectorReverseIterator<T> &a, const VectorConstReverseIterator<T> &b){
	return a.getValue() == b.getValue();
}
