...
/*   Updated: 2020/02/09 23:14:02 by hyoon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sam(DATA *data, char *str, int n)
{
	int		i;
	int		num;
	...
	num = ft_atoi(&str[1]);
	if (num < 20 && num != 0)
		printf("%s ", data[num].value);
	else if (num != 0)
	{
		printf("%s ", data[num / 10 + 18].value);
		if (num % 10 != 0)
			printf("%s ", data[num % 10].value);
	}
	if (n != 0)
		printf("%s", data[28 + n].value);
	return ;
